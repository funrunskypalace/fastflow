...
#define WMB() __asm__ __volatile__("lwsync" \
                                   :        \
                                   :        \
                                   : "memory")
#define PAUSE()
...
#define WMB() __asm__ __volatile__("mf" \
                                   :    \
                                   :    \
                                   : "memory")
#define PAUSE()
...
#define WMB() __asm__ __volatile__("dmb st" \
                                   :        \
                                   :        \
                                   : "memory")
#define PAUSE()
...
#if (defined(WIN32))                          // || defined(__INTEL_COMPILER)) && defined(WIN32)
...
#if defined(WIN32)
  if (ptr)
    posix_memalign_free(ptr); // defined in platform.h
